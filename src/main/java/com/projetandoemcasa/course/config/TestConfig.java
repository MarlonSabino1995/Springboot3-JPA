package com.projetandoemcasa.course.config;
...
import com.projetandoemcasa.course.entities.Payment;
...
import com.projetandoemcasa.course.repositories.OrderItemRepository;
import com.projetandoemcasa.course.repositories.OrderRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		userRepossitory.saveAll(Arrays.asList(u1, u2));
